...
author: "Oliver Rittmann & Domantas Undzėnas"
...
y_continuous <- mu + rnorm(N, mean = 0, sd = 3)
...
Simply simulate from your model, identify the response function (inverse link function) that describes your statistical model family, and construct expected values. If you care about predictions, additionally sample from the relevant stochastic component. 
